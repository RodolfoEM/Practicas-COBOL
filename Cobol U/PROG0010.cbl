      ...
      *> ------------------------------------------------------
       ...
       FILE-CONTROL.
           SELECT EMPLEADOS ASSIGN TO "C:\Cobol UDEMY\EMPLEADO.txt".
           SELECT REPORTE   ASSIGN TO "C:\Cobol UDEMY\REPORTE.txt".
      ...
      *SE DECLARA EL COPY A UTILIZAR
           COPY REGEMPLE

       01  WS-AREAS-A-USAR.

      *** ESTO SE COMENTA Y SE MANDA A COPY***
      *    05 WS-REG-EMPLEADOS.
      ...
      * LINKAGE SECTION.
       01  LK-FECHA.
           05 FILLER              PIC X(02).
           05 LK-DIA              PIC 9(02) VALUE 04.
           05 LK-MES              PIC 9(02) VALUE 10.
           05 LK-ANIO             PIC 9(04) VALUE 22.
